...
function pt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    ao ||
      ((ao = !0), he.unstable_scheduleCallback(he.unstable_NormalPriority, nf)))
}
function Ft(e) {
  function n(l) {
    return pt(l, e)
...
function Vs(e) {
  if (e.propertyName === 'value' && rl(jt)) {
    var n = []
    $s(n, jt, e, Go(e)), Ss(Of, n)
  }
}
function Df(e, n, t) {
  e === 'focusin'
    ? (ri(), (xt = n), (jt = t), xt.attachEvent('onpropertychange', Vs))
    : e === 'focusout' && ri()
}
function If(e) {
...
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Pr(e, n), Na(n, t, r), _o(n, t, r, l), (r = !0)
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps
    u.props = i
...
function Re(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
      ...
      de(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((lt = W() + 500), ul && mn()))
}
function de(e, n) {
  ...
  if (((r = e), typeof e == 'function')) zu(e) && (u = 1)
    ...
    e: switch (e) {
      ...
      case Ko:
        ...
        break
      case Yl:
        return (e = ke(12, t, n, l | 2)), (e.elementType = Yl), (e.lanes = o), e
      case Xl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Jo(n, t | 1), de(n, W()), !(R & 6) && ((lt = W() + 500), mn()))
      }
      break
    case 13:
      Ln(function () {
...
gs = xu
ws = Ln
var Ld = { usingClientEntryPoint: !1, Events: [Jt, Un, ol, hs, ys, xu] },
  yt = {
...
const Od = () => {
    ...
    return (
      ...
      wn.jsxs(wn.Fragment, {
        children: [
          wn.jsx('h1', { children: e }),
          wn.jsx('h2', { children: t }),
          wn.jsx('button', {
            onClick: () => r((l) => l + 1),
            children: '+Click',
          }),
...
if (Hi)
  Ql.createRoot(Hi).render(wn.jsx(wc.StrictMode, { children: wn.jsx(Od, {}) }))
